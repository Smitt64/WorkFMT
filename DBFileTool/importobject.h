...
public:
    ...
    bool importTable(const QString &datFile, const QDir &workDir);
    bool importTables(const QStringList &datFiles, const QDir &workDir);
...
signals:
    ...
    void importTableFinished(const QString &datFile, bool success, int rows);
