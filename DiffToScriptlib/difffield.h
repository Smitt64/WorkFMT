...
class DIFFTOSCRIPTL_EXPORT ExceptionOutOfRange: public QException
{
public:
...
class DIFFTOSCRIPTL_EXPORT IndexField : public QObject
{
    Q_OBJECT
...
class DIFFTOSCRIPTL_EXPORT DiffField: public IndexField
{
    Q_OBJECT
...
class DIFFTOSCRIPTL_EXPORT DiffFields: public ListIterableObject<DiffField*>
{
    Q_OBJECT
public:
    virtual ~DiffFields();
...
class DIFFTOSCRIPTL_EXPORT DatIndex : public QObject
{
    Q_OBJECT
    Q_PROPERTY(QString name READ getName CONSTANT)
...
class DIFFTOSCRIPTL_EXPORT DatIndexes : public ListIterableObject<DatIndex*>
{
    Q_OBJECT
public:
    DatIndexes();
