...
class DIFFTOSCRIPTL_EXPORT JoinIndex: public QObject, public IntegerVectorMap
{
    Q_OBJECT
...
class DIFFTOSCRIPTL_EXPORT JoinList: public ListIterableObject<Join*, CachedObjectDeleter>
{
    Q_OBJECT
public:
...
class DIFFTOSCRIPTL_EXPORT Join : public QObject
{
    Q_OBJECT
...
class DIFFTOSCRIPTL_EXPORT BoolVector : public VectorIterableObject<bool>
{
    Q_OBJECT
public:
    BoolVector() = default;
...
class DIFFTOSCRIPTL_EXPORT JoinTable : public QObject
{
    Q_OBJECT
...
class DIFFTOSCRIPTL_EXPORT JoinTableList : public ListIterableObject<JoinTable*, CachedObjectDeleter>
{
    Q_OBJECT
public:
...
class DIFFTOSCRIPTL_EXPORT JoinTables : public QObject
{
    Q_OBJECT
