...
class DIFFTOSCRIPTL_EXPORT LinkField : public QObject
{
    Q_OBJECT
...
class DIFFTOSCRIPTL_EXPORT LinkFieldList : public ListIterableObject<LinkField*, CachedObjectDeleter>
{
public:
...
class DIFFTOSCRIPTL_EXPORT Link : public QObject
{
    Q_OBJECT
...
class TableLinks;
class DIFFTOSCRIPTL_EXPORT TableLinksList : public ListIterableObject<TableLinks*, CachedObjectDeleter>
{
    Q_OBJECT
public:
...
class DIFFTOSCRIPTL_EXPORT TableLinks : public QObject
{
    Q_OBJECT
    Q_PROPERTY(QString tableName READ getTableName CONSTANT)
