...
FmtUndoFieldProperty::FmtUndoFieldProperty(FmtTable *table, const qint16 &row, QUndoCommand *parent) :
    QUndoCommand(parent)
{
    m_FldRow = row;
    pTable = table;
...
void FmtUndoFieldProperty::setProperty(const qint16 &property)
{
