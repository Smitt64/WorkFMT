 ...
 *
 * $Id: compiler.in@#/main/spm_bldmdl/4  09/11/97 11:15:37  kevinj (TOOLS707_WIN32_971021)
 * $Revision: 7.122 $
 *
 ...
 *** RW_MUTEXATTR_DEFAULT: Defined if pthread_mutexattr_default is
...
#    define RW_MSVC_STDLIB 0x0420 /* version 4.2 from fall 1996 */
#  endif
#  define RW_NO_XDR                        1
#  define RW_NO_POSIX_RE                   1
...
#      define RW_NO_TYPENAME_OUTSIDE_DECLARATION  1
#    endif
#  endif
#  ifdef _RWBUILDDLL
#    define __DLL__         1
...
#  define RW_DEALLOC_TYPE(A,oA,P)   _DEALLOCATE_X(oA,A,P)
#endif

#ifdef RW_RWV12_STDLIB
#  define RW_ALLOC_TYPE(T,A,oA,N,H)   oA.allocate(N,H)
#  define RW_DEALLOC_TYPE(A,oA,P)     oA.deallocate(P)
#endif
