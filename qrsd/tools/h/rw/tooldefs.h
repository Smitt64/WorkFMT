 ...
 *
 * $Id: tooldefs.h@#/main/35  08/21/97 12:20:35  kevinj (TOOLS707_WIN32_971021)
 *
...
#define RWTOOLS 0x0707  /* Version number */
// Part of 7.10
...
inline unsigned RWhashAddress(const void *a)
{
  ...
  return (unsigned)(intptr_t)a ^ ((unsigned)(intptr_t)a >> 3);
}
